...
| `examples/packs/*` (6), `examples/patterns/*`         | pack manifests, prompts, lenses, translation pattern cards      | `kits/*/packs/*` (7), `kits/mainframe-java/patterns`   | `kits/test/packs.test.ts`                | shipped reference packs              |
| `examples/fixtures/scaffolds/*` (4)                   | target-repository scaffolds seeded into an empty target         | `kits/*/scaffolds/*` (4)                               | `kits/test/packs.test.ts`                | seeding a fresh target               |
